...
class SongsAdaptor( private val songList: MutableList<Song>, private val onItemListener: OnItemListener) : RecyclerView.Adapter<SongsAdaptor.SongsViewHolder>(), Filterable {
    private val songListFull: ArrayList<Song> = ArrayList(songList)


    // called by recycle viewer when its time to create a new view holder, return type is ExViewhodler
